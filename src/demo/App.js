...
class App extends Component {
    ...
    render() {
            ...
            return ( <
                    ...
                    ref = "dropdown"
                    onChange = {
                        this.handleDataSelectionChange
                    } > {
                        this.state.availableLanguages.map((item, index) => < option className = ""
                            key = {
                                index + '_' + item
                            }
                            value = {
                            ...
                            select id = "accessClass"
                            className = ""
                            ref = "accessibilty"
                            onChange = {
                                this.handleAccessibiltySelectionChange
                            } > {
                                this.state.availableThemes.map((item, index) => < option className = ""
                                    key = {
                                        index + '_' + item
                                    }
                                    value = {
                                    ...
                                    input id = "showWordsHighlighted"
                                    ref = "wordsToHighlight"
                                    onChange = {
                                        this.updateHighlightedWords
                                    }
                                    /> <
                                    button onClick = {
                                        this.clearHightlightedWords
                                    } > Clear < /button> < /
                                    div > <
                                    /section> < /
                                    div > <
                                    ...
                                    height = {
                                        this.wordCloudHeight
                                    }
                                    scoreKey = {
                                        "freq"
                                    }
                                    highlightWords = {
                                        this.state.arrHighlightWords
                                    }
                                    handleLeftClick = {
